...
import com.example.payment.monolith.payment.domain.PaymentExtraDetails
import com.example.payment.monolith.payment.domain.PaymentFailure
...
data class PaymentStatusUpdateCommand(
    ...
    init {
        ...
        if (status == PaymentStatus.SUCCESS) {
            ...
            requireNotNull(failure) { "PaymentStatus 값이 FAILURE 라면 PaymentFailure 는 null 이 되면 안됩니다." }
        }
    }
}
